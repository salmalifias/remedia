    ...
    return (
      <nav className="navbar p-0 fixed-top d-flex flex-row">
        <div className="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
          <Link className="navbar-brand brand-logo-mini" to="/"><img src={require('../../assets/images/logoo.png')} alt="logo" /></Link>
        </div>
            ...
            <Dropdown alignRight as="li" className="nav-item">
              ...
              <Dropdown.Menu className="dropdown-menu navbar-dropdown preview-list">
                ...
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject mb-1">EXTEND OPEN RECRUITMENT</p>
                ...
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                  ...
                  <div className="preview-item-content">
                    <h6 className="preview-subject mb-1">INFORMASI SEPUTAR PPK</h6>
                    <p className="text-muted ellipsis mb-0">
                    Permintaan diterima
                    </p>
                  </div>
                ...
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                  ...
                  <div className="preview-item-content">
                    <h6 className="preview-subject mb-1">WUJUDKAN KAMPUS YANG AMAN</h6>
                    <p className="text-muted ellipsis mb-0">
            ...
            <Dropdown alignRight as="li" className="nav-item">
              <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
                <div className="navbar-profile">
                  ...
                  <p className="mb-0 d-none d-sm-block navbar-profile-name">Media Kreatif</p>
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list navbar-profile-dropdown-menu">
                ...
                <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject mb-1">Account</p>
                  </div>
                </Dropdown.Item>
                <Dropdown.Divider />
                <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()}  className="preview-item">
