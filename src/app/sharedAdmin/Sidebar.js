    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          ...
          <a className="sidebar-brand brand-logo-mini" href="index.html"><img src={require('../../assets/images/logoo.png')} alt="logo" /></a>
        </div>
        <ul className="nav">
                ...
                <Dropdown.Menu className="sidebar-dropdown preview-list">
                  <a href="!#" className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                    ...
                    <div className="preview-item-content">
                      <p className="preview-subject ellipsis mb-1 text-small">Tambah Kabinet</p>
                    </div>
                  </a>
                </Dropdown.Menu>
              </Dropdown>
          ...
          <li className={ this.isPathActive('/login') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
