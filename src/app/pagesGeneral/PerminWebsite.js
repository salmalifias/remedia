...
export class PerminWebsiteG extends Component {
  render () {
    return (
      <div>
        <div className="row">
          <div className="col-md-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Permintaan Website</h4>
                <p className="card-description">Silahkan masukkan detail permintaan website. Diharapkan untuk mendeskripsikan secara lengkap dan jelas.</p>
                <form className="forms-sample">
                  <Form.Group>
                    <label htmlFor="exampleInputUsername1">Judul Permintaan Website</label>
                    <Form.Control type="text" id="judul" placeholder="Judul Permintaan" />
                  </Form.Group>
                  <Form.Group>
                    <label htmlFor="exampleInputEmail1">Jam Publikasi</label>
                    <Form.Control type="text" className="form-control" id="waktu" placeholder="Jam Publikasi" />
                  </Form.Group>
                  <Form.Group>
